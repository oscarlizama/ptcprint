				...
				<?php 
					...
					foreach ($con->query($sql) as $datos) {
						$empresa_datos .= "<div class='col-lg-6 col-md-6'>";
                    		...
                    		$empresa_datos .= "<textarea type='text' class='form-control input estira2' id='mision'>$datos[2]</textarea autocomplete='off'>";
                    		$empresa_datos .= "<br>";
                    		$empresa_datos .= "<label for='' class='labels'>Visión</label>";
                    		$empresa_datos .= "<textarea type='text' class='form-control input estira2' id='vision' autocomplete='off'>$datos[3]</textarea>";
                    		$empresa_datos .= "<br>";
                    		$empresa_datos .= "<label for='' class='labels'>Valores</label>";
                    		$empresa_datos .= "<textarea type='text' class='form-control input estira2' id='valores'>$datos[4]</textarea autocomplete='off'>";
                    		$empresa_datos .= '<br>';
                    	$empresa_datos .= "</div>";
