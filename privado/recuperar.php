...
<body>
	<div class="container-fluid" id="login-p">
		<div class="row">
			...
			<br>
			<br>
			<h2 class="h-negro text-center">Recuperar contarseña de Punto Print</h2>
			<br>
			<div class="col-lg-4 col-md-4 col-sm-6 col-sm-offset-3 col-lg-offset-4 col-md-offset-4 text-center" id="frm">
				<form method="post" action="recuperaradmin">
					...
					<br>					
					<input name="correo" placeholder="Email" class="form-control text-center" autocomplete="off"required autocomplete='off'>
					<br>
					<button class="btn btn-primary col-md-12 col-lg-12 col-xs-12 col-sm-12" name="recuperar">Recuperar contraseña</button>
				</form>
			</div>
		</div>
	</div>
