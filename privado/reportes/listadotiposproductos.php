<?php 
	...
	$pdf->Cell(50,6,'CANTIDAD DE PRODUCTOS',1,0,'C',1);
	...
	while ($datos = $stmt->fetch(PDO::FETCH_BOTH)) {
		$pdf->Cell(90,10,utf8_decode($datos[0]),1,0,'L',0);
	   	$pdf->Cell(50,10,utf8_decode($datos[1]),1,0,'C',0);
		//Muestro la iamgen dentro de la celda GetX y GetY dan las coordenadas actuales de la fila
	 	$pdf->Cell(45,10,utf8_decode($datos[2]), 1, 0, 'C', false );
		$pdf->Ln(10);
	}
