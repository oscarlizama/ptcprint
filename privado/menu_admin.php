...
<div class="opciones-menubk">
	<div id="inner">
		<ul class="op-bk">
			<li class="sub-mbk">
				<div class="texto">
					<div class="glyph">
						<span class="glyph-icon flaticon-flat"></span>
						<p class="nombre-opcion">Empresa</p>
					</div>
				</div>
				<div class="dv-sub">
					<ul>
			...
			<li class="sub-mbk">
				<div class="texto">
					<div class="glyph">
						<span class="glyph-icon flaticon-truck"></span>
						<p class="nombre-opcion">Proveedores</p>
					</div>
				</div>
				<div class="dv-sub">
					<ul>
			...
			<li class="sub-mbk">
				<div class="texto">
					<div class="glyph">
						<span class="glyph-icon flaticon-triptych-brochure"></span>
						<p class="nombre-opcion">Productos</p>
					</div>
				</div>
				<div class="dv-sub">
					<ul>
			...
			<li class="sub-mbk">
				<div class="texto">
					<div class="glyph">
						<span class="glyph-icon flaticon-command"></span>
						<p class="nombre-opcion">Usuarios</p>
					</div>
				</div>
				<div class="dv-sub">
					<ul>
				...
				<a href="configuraciones.php">
					<div class="texto">
						<div class="glyph">
							...
							<p class="nombre-opcion">Configuraciones</p>
						</div>
					</div>
				</a>
			</li>
