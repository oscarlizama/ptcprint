		...
		<div>
            <div class="container-fluid div_conteni">
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#home">PUERTAS</a></li>
                    <li><a data-toggle="tab" href="#menu1">VENTANAS</a></li>
                    <li><a data-toggle="tab" href="#menu2">VITRINAS</a></li>
                    <li><a data-toggle="tab" href="#menu3">PARABRISAS</a></li>
                </ul>
                <div class="tab-content">
                    <div id="home" class="tab-pane fade in active">
                        <div class="uk-grid">
                            <div class="uk-width-1-1 uk-flex uk-flex-center publicidad-header">
                                <h2 class="titulos">Microperforado | Puertas</h2>
                            </div>
                        </div>
                        ...
                        <div class="container-fluid">
                            <div class="uk-grid row">
                                <div class="uk-width-small-5-10 uk-width-medium-4-10 uk-width-large-3-10">
                                    <img src="img/micro1.png" alt="">
                                    <a href="img/micro1.png" data-uk-lightbox="" class="uk-button uk-button-link uk-button-large uk-flex uk-flex-center">VER EJEMPLO</a>
                                </div>
                                    ...
                                    <div class="uk-grid">
                                        <div class="uk-width-small-1-1 uk-width-medium-5-10 uk-width-large-4-10">
                                            ...
                                            <form class="uk-form">
                                                ...
                                                <input type="radio" id="form-s-r" name="radio"> <label for="form-s-r">720X1200</label><br>
                                            </form>
                                        </div>
                                        <!--AQUI SE PUNTUA-->
                                        <div class="uk-hidden-small uk-width-medium-5-10 uk-width-large-5-10">
                                            <p>DESCRIPCION</p>
                                            <p>Microperforado en puertas, perfecto para tu negocio. Consiguelo ahora.</p>
                    ...
                    <div id="menu1" class="tab-pane fade">
                        <div class="uk-grid">
                            <div class="uk-width-1-1 uk-flex uk-flex-center publicidad-header">
                                <h2 class="titulos">Microperforado | Ventanas</h2>
                            </div>
                        </div>
                        ...
                        <div class="container-fluid">
                            <div class="uk-grid row">
                                <div class="uk-width-small-5-10 uk-width-medium-4-10 uk-width-large-3-10">
                                    ...
                                    <a href="img/micro2.png" data-uk-lightbox="" class="uk-button uk-button-link uk-button-large uk-flex uk-flex-center">VER EJEMPLO</a>
                                </div>
                                <!--AQUI ESTA LA INFORMACION DEL PRODUCTO-->
                                <div class="uk-width-small-5-10 uk-width-medium-6-10 uk-width-large-7-10">
                                    <div class="uk-grid">
                    ...
                    <div id="menu2" class="tab-pane fade">
                        <div class="uk-grid">
                            <div class="uk-width-1-1 uk-flex uk-flex-center publicidad-header">
                                <h2 class="titulos">Microperforado | Vitrinas</h2>
                            </div>
                        </div>
                        <!--CONTENEDOR DE LA INFORMACION-->
                        <br>
                            ...
                            <div class="uk-grid row">
                                ...
                                <div class="uk-width-small-5-10 uk-width-medium-6-10 uk-width-large-7-10">
                                    <div class="uk-grid">
                                        ...
                                        <div class="uk-hidden-small uk-width-medium-5-10 uk-width-large-5-10">
                                            <p>DESCRIPCION</p>
                                            <p>Microperforado en vitrina, perfecto para publicidad en pequeña empresa y de gran calidad.. Consiguelo ahora.</p>
                                            <p class="uk-hidden-medium uk-hidden-small ">Puntuación:</p>
                                            <div class="stars">
                                                <span class="uk-icon-star uk-icon-small uk-hidden-medium uk-hidden-small puntuar"></span>
                                                <span class="uk-icon-star uk-icon-small uk-hidden-medium uk-hidden-small puntuar"></span>
                    ...
                    <div id="menu3" class="tab-pane fade">
                        <div class="uk-grid">
                            <div class="uk-width-1-1 uk-flex uk-flex-center publicidad-header">
                                <h2 class="titulos">Microperforado | Parabrisas</h2>
                            </div>
                        </div>
                        <!--CONTENEDOR DE LA INFORMACION-->
                        <br>
                        <div class="container-fluid">
                            <div class="uk-grid row">
                                <div class="uk-width-small-5-10 uk-width-medium-4-10 uk-width-large-3-10">
                                    ...
                                    <a href="img/micro3.png" data-uk-lightbox="" class="uk-button uk-button-link uk-button-large uk-flex uk-flex-center">VER EJEMPLO</a>
                                </div>
                                <!--AQUI ESTA LA INFORMACION DEL PRODUCTO-->
                                <div class="uk-width-small-5-10 uk-width-medium-6-10 uk-width-large-7-10">
                                    <div class="uk-grid">
                                        ...
                                        <div class="uk-hidden-small uk-width-medium-5-10 uk-width-large-5-10">
                                            <p>DESCRIPCION</p>
                                            <p>Microperforado en puertas, perfectos para publicidad en negocios. Consiguelo ahora.</p>
                                            <p class="uk-hidden-medium uk-hidden-small ">Puntuación:</p>
                                            <div class="stars">
                                                <span class="uk-icon-star uk-icon-small uk-hidden-medium uk-hidden-small puntuar"></span>
                                                <span class="uk-icon-star uk-icon-small uk-hidden-medium uk-hidden-small puntuar"></span>
        ...
        <div class="uk-slidenav-position" data-uk-slider>
            <div class="uk-slider-container">
                <ul class="uk-slider uk-grid-small uk-grid-width-small-1-2 uk-grid-width-medium-1-4 uk-grid-width-large-1-4">
                    <li><img src="img/micro1.png"alt=""></li>
                    <li><img src="img/micro2.png" alt=""></li>
                    <li><img src="img/micro3.png" alt=""></li>
                    <li><img src="img/micro.png" alt=""></li>
                    <li><img src="img/micros8.png" alt=""></li>
                </ul>
            </div>
