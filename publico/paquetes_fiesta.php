<html>
    <head>
        <title>Paquetes de Fiesta | Punto Print</title>
    ...
    <div>
        ...
        <div class="container-fluid div_conteni">
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#home">INVITACIONES</a></li>
                <li><a data-toggle="tab" href="#menu1">GORROS Y CORONAS</a></li>
            </ul>
            <div class="tab-content">
                <div id="home" class="tab-pane fade in active">
                    <div class="uk-grid">
                        <div class="uk-width-1-1 uk-flex uk-flex-center publicidad-header">
                            <h2 class="titulos">Invitaciones todo tipo.</h2>
                        </div>
                    </div>
                    ...
                    <?php 
                            ...
                            $maximo = "SELECT p.id_producto FROM productos p WHERE p.id_tipo_producto=18 AND p.calificacion_promedio = (SELECT MAX(p.calificacion_promedio) FROM productos) LIMIT 1";
                ...
                <div id="menu1" class="tab-pane fade">
                    <div class="uk-grid">
                        <div class="uk-width-1-1 uk-flex uk-flex-center publicidad-header">
                        <h2 class="titulos">Gorros y Coronas</h2>
                    </div>
                    <!--CONTENEDOR DE INFORMACION-->
                    <br>
                    <?php 
                            ...
                            $foto_producto = "";
                            $calificacion_promedio = "";
                            $maximo = "SELECT p.id_producto FROM productos p WHERE p.id_tipo_producto=19 AND p.calificacion_promedio = (SELECT MAX(p.calificacion_promedio) FROM productos) LIMIT 1";
                            foreach ($con->query($maximo) as $maximo) {
                              $id_max = $maximo[0];
                            }
                            $producto = "SELECT p.nombre_producto, p.descripcion_producto, p.calificacion_promedio,f.foto_producto FROM productos p INNER JOIN fotos_productos f ON f.id_producto = p.id_producto WHERE p.id_producto=$id_max";
    ...
    <div class="uk-width-1-1 uk-text-center">
        <div id="productos-solicitados">
            <br>
            <!--Poniendo un encabezado al sidenav de productos-->
            <p class="productos-titulo">
                <h2 class="titulos uk-hidden-small">NUESTROS PRODUCTOS HACER</h2>
        ...
        <div class="uk-margin slideset-servicios" data-uk-slideset="{animation:'fade', duration:'170', small:2, medium:3, large:4}">
            <div class="uk-slidenav-position uk-margin">
                <ul class="uk-slideset uk-grid uk-flex-center">
                    <li><img src="img/invi1.png" class="img-servicios" alt=""></li>
                    <li><img src="img/invi2.png" class="img-servicios" alt=""></li>
                    <li><img src="img/invi3.png" class="img-servicios" alt=""></li>
                    <li><img src="img/invi4.png" class="img-servicios" alt=""></li>
                    <li><img src="img/invi5.png" class="img-servicios" alt=""></li>
                    <li><img src="img/invi6.png" class="img-servicios" alt=""></li>
                    <li><img src="img/invi7.png" class="img-servicios" alt=""></li>
                    <li><img src="img/invi8.png" class="img-servicios" alt=""></li>
                    <li><img src="img/gorro1.png" class="img-servicios" alt=""></li>
                    <li><img src="img/gorro2.png" class="img-servicios" alt=""></li>
                    <li><img src="img/gorro3.png" class="img-servicios" alt=""></li>
                    <li><img src="img/gorroportada.png" class="img-servicios" alt=""></li>
                    <li><img src="img/gorro4.png" class="img-servicios" alt=""></li>
                    <li><img src="img/gorro5.png" class="img-servicios" alt=""></li>
                </ul>
        ...
        <div class="uk-margin slideset-servicios" data-uk-slideset="{animation:'fade', duration:'170', small:2, medium:3, large:4}">
            <div class="uk-slidenav-position uk-margin">
                <ul class="uk-slideset uk-grid uk-flex-center">
                    <li><img src="img/gorro7.png" class="img-servicios" alt=""></li>
                    <li><img src="img/gorro8.png" class="img-servicios" alt=""></li>
                    <li><img src="img/indi9.png" class="img-servicios" alt=""></li>
                    <li><img src="img/indi2.png" class="img-servicios" alt=""></li>
                    <li><img src="img/indi3.png" class="img-servicios" alt=""></li>
                    <li><img src="img/recuerdo5.png" class="img-servicios" alt=""></li>
                    <li><img src="img/recuerdo2.png" class="img-servicios" alt=""></li>
                    <li><img src="img/recuerdo1.png" class="img-servicios" alt=""></li>
                    <li><img src="img/ban1.png" class="img-servicios" alt=""></li>
                    <li><img src="img/ban2.png" class="img-servicios" alt=""></li>
                    <li><img src="img/ban7.png" class="img-servicios" alt=""></li>
                    <li><img src="img/ban8.png" class="img-servicios" alt=""></li>
                    <li><img src="img/indi6.png" class="img-servicios" alt=""></li>
                    <li><img src="img/indi7.png" class="img-servicios" alt=""></li>
                </ul>
                <a href="#" class="uk-slidenav uk-slidenav-previous" data-uk-slideset-item="previous"></a>
                <a href="#" class="uk-slidenav uk-slidenav-next" data-uk-slideset-item="next"></a>
            </div>
        ...
        <div class="uk-margin slideset-servicios" data-uk-slideset="{animation:'fade', duration:'170', small:2, medium:3, large:4}">
            <div class="uk-slidenav-position uk-margin">
                <ul class="uk-slideset uk-grid uk-flex-center">
                    <li><img src="img/indi1.png" class="img-servicios" alt=""></li>
                    <li><img src="img/recuerdo3.png" class="img-servicios" alt=""></li>
                    <li><img src="img/indi4.png" class="img-servicios" alt=""></li>
                    <li><img src="img/recuerdo4.png" class="img-servicios" alt=""></li>
                    <li><img src="img/indi_5.png" class="img-servicios" alt=""></li>
                    <li><img src="img/ban3.png" class="img-servicios" alt=""></li>
                    <li><img src="img/ban6.png" class="img-servicios" alt=""></li>
                    <li><img src="img/recuerdo6.png" class="img-servicios" alt=""></li>
                    <li><img src="img/ban4.png" class="img-servicios" alt=""></li>
                    <li><img src="img/ban5.png" class="img-servicios" alt=""></li>
                    <li><img src="img/recuerdo6.png" class="img-servicios" alt=""></li>
                    <li><img src="img/recuerdo7.png" class="img-servicios" alt=""></li>
                    <li><img src="img/recuerdo8.png" class="img-servicios" alt=""></li>
                    <li><img src="img/recuerdo4.png" class="img-servicios" alt=""></li>
                </ul>
                <a href="#" class="uk-slidenav uk-slidenav-previous" data-uk-slideset-item="previous"></a>
                <a href="#" class="uk-slidenav uk-slidenav-next" data-uk-slideset-item="next"></a>
